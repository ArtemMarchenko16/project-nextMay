...
export const baseURLForGetMovies = "https://api.themoviedb.org/3/discover/movie?page=1";
export const baseURLForGetMoviesById = "https://api.themoviedb.org/3/discover/movie";
